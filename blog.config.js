...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '我想和你一起生活, 共享无尽的黄昏，和绵绵不绝的钟声，在某个小镇',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '葵崽饲养员', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '朝霞化精灵 轻快 明亮 恒温的伴侣 她与你共存 违背 对抗 相同的命运', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://shmilyshen.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '日记', // 网站关键词 英文逗号隔开
